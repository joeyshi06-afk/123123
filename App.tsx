  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <div className={`absolute top-[5%] left-0 w-full flex justify-center pointer-events-none z-0 transition-opacity duration-700 ${isSignatureOpen ? 'opacity-0' : 'opacity-100'}`}>
        <h1 
            className="font-['Caveat'] italic text-6xl md:text-9xl text-center leading-[1.5] py-10"
            style={{
      ...
      <div className={`absolute bottom-12 left-12 z-20 pointer-events-none transition-opacity duration-500 ${isSignatureOpen ? 'opacity-0' : 'opacity-100'}`}>
            <div className="text-white/90 text-[26px] uppercase tracking-widest font-['Caveat'] italic">
                <div>From RTS Asia</div>
                <div className="text-slate-500">25.12.2025</div>
            </div>
      </div>
